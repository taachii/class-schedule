  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.nav}>
        <button className={styles.navBtn} onClick={prevMonth} aria-label="Poprzedni miesiąc">←</button>
        <h2 className={styles.monthTitle}>{MONTH_NAMES_PL[currentMonth]} {currentYear}</h2>
        <button className={styles.navBtn} onClick={nextMonth} aria-label="Następny miesiąc">→</button>
      </div>
